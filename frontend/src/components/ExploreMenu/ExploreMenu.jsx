...
const ExploreMenu = ({Category, setCategory}) => {
  return (
    <div id='explore-menu' className='explore-menu flex flex-col gap-[20px] my-16'>
        ...
        <p className='explore-menu-text w-[66%]'> Books are windows to knowledge, imagination, and discovery. Our collection spans diverse categories, ensuring every reader finds something inspiring, educational, or entertaining. Each visit opens a new world of ideas and stories..</p>
